...
bash heuristic.sh --predictor_daily_config_file examples/config/phase_3_2_daily/phase_3_2_cnn_1d_config.json --predictor_hourly_config_file examples/config/phase_3_2/phase_3_2_transformer_1h_config.json --base_dataset_file examples/data/phase_3/base_d6.csv --prefix _high_frequency --max_trades_per_5days 20
...
bash heuristic.sh --predictor_daily_config_file examples/config/phase_3_2_daily/phase_3_2_cnn_1d_config.json --predictor_hourly_config_file examples/config/phase_3_2/phase_3_2_transformer_1h_config.json --base_dataset_file examples/data/phase_3/base_d6.csv --prefix _low_frequency --max_trades_per_5days 3
